package com.mort.easyllm.llm.tongyi.utils;

import com.alibaba.dashscope.common.Message;
import com.alibaba.dashscope.common.Role;
import com.mort.easyllm.llm.tongyi.enums.TongyiRole;

import java.util.*;

public class MessagesBuildUtil {
    ...
    public static List<Message> toTongyiMessageConverter(List<com.mort.easyllm.common.parameter.Message> messages) {
